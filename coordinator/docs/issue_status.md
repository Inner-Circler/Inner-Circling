...
- `--dry-run` (optional flag): compute and print the full plan (transitions, renames, history excerpts) but write nothing and skip the downstream regeneration chain entirely. Default: off.
