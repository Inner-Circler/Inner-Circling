...
that half is `practice_manager.py` now: a merged register of circle-facing practices and "better options" (the rows addressed to Self: "how you move"), with its own CRUD surface, the resolution half of a staging/vetting pipeline, and a verifier.
